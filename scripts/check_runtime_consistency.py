...
def generated_fixture_bare_calls() -> tuple[list[str], Path, set[str], set[str], set[str]]:
    ...
    for fixture_name in ("fixtureFlexibleGallery.msapp", "fixtureScaledFlexibleGallery.msapp", "fixtureButtonIcons.msapp", "fixtureNativeLayout.msapp", "fixtureScaledNativeLayout.msapp",
